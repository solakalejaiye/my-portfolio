...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    title:"How Building Trust and Transparency Led to 2x Growth for Heroshe",
    subtitle:"Not knowing where your package is can feel like losing control of your shopping experience. What if we could turn that uncertainty into confidence by keeping users informed every step of the way?",
    ...
    metrics:[{value:"2x",label:"Drop in processing time"},{value:"70%",label:"Fewer irate calls"},{value:"20k",label:"New Signups in 6 months"}],
    sections:[
      {title:"Heroshe: An Overview",body:"Heroshe is a freight-forwarding company that empowers African shoppers to access global e-commerce platforms like Amazon, eBay, and AliExpress. By providing package consolidation, shipping, and delivery from the US, UK, and China, Heroshe bridges the gap between international stores and African shoppers. It addressed a critical gap in the market: many international stores did not deliver to Nigeria, and shipping costs from companies like DHL and FedEx were prohibitively high. Heroshe became an affordable and reliable alternative."},
      {title:"Listening to Real Voices",body:"We knew we couldn’t fix what we didn’t understand, so we spoke with everyone. We asked about 10 of our most frequent shoppers and sent a survey that received 200+ responses. The common theme was: “I want to know the second my package arrives. Not a day later, not a week later.” Customer Success shared transcripts of irate users repeatedly calling about package status, while warehouse and logistics teams identified inefficiencies in the linear processing flow and ways to trigger earlier updates."},
      {title:"What We Found Out",body:"Delayed notifications caused anxiety: customers wanted reassurance that their package had reached the warehouse, even when they did not expect immediate processing. Linear processing created bottlenecks because logging happened only after full processing. Lack of communication eroded confidence, while status questions overwhelmed support and diverted resources from complex issues."},
      {title:"Notifications should start as soon as the package arrives, not when processing is complete",body:"This became the key insight that guided the redesign."},
      {title:"Reimagining the Process",body:"Our team brainstormed solutions to improve package-tracking transparency and backend efficiency. By involving warehouse and logistics teams, we created a new flow that allowed multiple staff members to handle different steps in parallel."},
      {title:"1. Multi-Stage Processing — Inbound First, Process Later",body:"Packages are inbounded first, notifying shoppers of receipt; full processing and sorting happens later. This allowed multiple staff members to process packages simultaneously, reducing bottlenecks and ensuring faster updates.",image:"https://framerusercontent.com/images/z3myjTjgaeus7bcMBDMbZhuks.png?scale-down-to=2048&width=2880&height=1616"},
      {title:"2. Status Updates & Notifications",body:"Users were notified as soon as packages were received at the warehouse and at every status change, reducing anxiety."},
      {title:"3. Out-app Tracking — Track Without Logging In",body:"Users could track packages directly on the website without logging into their dashboard, improving accessibility and reducing the need to call support."},
      {title:"It wasn’t smooth sailing…",body:"Balancing real-time and manual triggers was tricky because some processes still required human input. We introduced semi-automation through a scanning system that logged packages immediately on arrival. Developers also reworked the backend architecture to support real-time updates and multi-stage tracking; it extended the timeline, but was essential."},
      {title:"What did I learn from this?",body:"Transparency builds trust: keeping users informed, even about small updates, made a substantial difference in their confidence. Good design cannot be achieved in a silo: engaging warehouse, logistics, and support teams was essential to a solution that worked for everyone.",image:"https://framerusercontent.com/images/tj2cmZs6mqMxRFLDbtwrRoTFgks.png?scale-down-to=2048&width=2880&height=1682"}
    ]
  }
];
